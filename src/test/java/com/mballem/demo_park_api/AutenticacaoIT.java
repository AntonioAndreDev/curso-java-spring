...
public class AutenticacaoIT {
    ...
    public void autenticar_ComCredenciaisValidas_RetornarTokenComStatus200() {
        JwtToken responseBody = testClient
                ...
                .bodyValue(new UsuarioLoginDto("antonio@gmail.com", "123456"))
                .exchange()
                .expectStatus().isOk()
    ...
    public void autenticar_ComCredenciaisInvalidas_RetornarErrorMessageComStatus400() {
        ErrorMessage responseBody = testClient
                ...
                .uri("/api/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioLoginDto("antonio@gmail.com", "654321"))
                .exchange()
    ...
    public void autenticar_ComUsernameInvalido_RetornarErrorMessageComStatus422() {
        ...
        responseBody = testClient
                ...
                .uri("/api/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioLoginDto("antonio@gmail", "123456"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void autenticar_ComPasswordInvalido_RetornarErrorMessageComStatus422() {
        ErrorMessage responseBody = testClient
                ...
                .uri("/api/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioLoginDto("antonio@gmail.com", ""))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .uri("/api/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioLoginDto("antonio@gmail.com", "123"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .uri("/api/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioLoginDto("antonio@gmail.com", "1234567"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
